      ...
      {activeTab === 'staking' && (
        <div className="animate-fadeIn font-mono">
          ...
          {currentUser ? (
            ...
            <button 
              className="w-full py-4 border border-g text-g font-bold tracking-[4px] uppercase text-xs hover:bg-g/15 hover:shadow-[0_0_20px_rgba(0,255,136,0.3)] transition-all duration-300 interactive-cursor"
              onClick={() => alert(t('W AI Studio Preview zasymulowano stakowanie. Zarejestruj się / zaloguj na konto węzła po prawej, aby stakować własny wykopany plon!', 'Staking simulated in AI Studio Preview. Register/login as a node on the right to stake your own mined balance!'))}
            >
